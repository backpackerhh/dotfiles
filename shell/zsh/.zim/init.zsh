zimfw() { source /home/david/.dotfiles/shell/zsh/.zim/zimfw.zsh "${@}" }
zmodule() { source /home/david/.dotfiles/shell/zsh/.zim/zimfw.zsh "${@}" }
fpath=(/home/david/.dotfiles/shell/zsh/.zim/modules/git-info/functions ${fpath})
